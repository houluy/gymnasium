...
from src.algos.sac import SoftActorCritic
from src.algos.td3 import TwinDelayedDDPG
from src.algos.randomsample import RandomSample
...
#agent = DQN(env_name, continuous=False, device=device)
#agent = VanillaActorCritic(env_name, continuous=False, device=device)
#agent = RandomSample(env_name, continuous=True, device=device)
...
#agent = TwinDelayedDDPG(env_name, continuous=True, device=device)
#agent = SoftActorCritic(env_name, continuous=True, device=device)
